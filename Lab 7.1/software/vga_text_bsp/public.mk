...
# setting SOPC_SYSID_BASE_ADDRESS is 0x80031d0
SOPC_SYSID_FLAG += --sidp=0x80031d0
ELF_PATCH_FLAG  += --sidp 0x80031d0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1648777497
SOPC_SYSID_FLAG += --timestamp=1648777497
ELF_PATCH_FLAG  += --timestamp 1648777497
